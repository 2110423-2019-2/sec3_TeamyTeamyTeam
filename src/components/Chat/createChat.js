...
import styles from './Chatdashboard/style';
...
class CreateChatComponent extends React.Component {
  ...
  render() {
    ...
    if(this.state.email) {
      return(
        ...
        return(); // Alert Fail to start chat
    }
  }
...
export default withStyles(styles)(CreateChatComponent);